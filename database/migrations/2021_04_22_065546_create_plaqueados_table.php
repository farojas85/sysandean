...
class CreatePlaqueadosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('plaqueados', function (Blueprint $table) {
            $table->id();
            $table->foreignId('lote_id')->nullable()->constrained('lotes');
            $table->float('kilogramo_plaqueado');
    ...
    {
        Schema::dropIfExists('plaqueados');
    }
}
