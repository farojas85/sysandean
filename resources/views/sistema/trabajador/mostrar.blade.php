<div class="modal fade" id="modal-mostrar-trabajador">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="modal-mostrar-trabajador-title">Mostrar Trabajador</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body" id="modal-mostrar-trabajador-body">
                <div class="form-group row">
                    <label for="" class='col-md-4 mb-1 col-form-label col-form-label-sm'>Documento Identidad</label>
                    <div class="col-md-8 mb-2">
                        <select v-model="trabajador.tipo_documento_id" class="form-control form-control-sm" disabled>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8 mb-2">
                        <input type="text" class="form-control form-control-sm" placeholder="Ingrese Número Documento de Identidad"
                            v-model="trabajador.numero_documento" maxlength="15" @keyUp="validarDocumento"  readonly/>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8 mb-2">
                        <input type="text" class="form-control form-control-sm" placeholder="Ingrese Nombres"
                            v-model="trabajador.nombres" readonly/>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8 mb-2">
                        <input type="text" class="form-control form-control-sm" placeholder="Ingrese Apellidos"
                            v-model="trabajador.apellidos" readonly />
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8 mb-2">
                        <input type="date" class="form-control form-control-sm" placeholder="Ingrese Fecha de Nacimiento"
                            v-model="trabajador.fecha_nacimiento" readonly />
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8 mb-2">
                        <input type="text" class="form-control form-control-sm" placeholder="Ingrese Lugar Nacimiento"
                            v-model="trabajador.lugar_nacimiento" readonly />
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8 mb-2">
                        <input type="checkbox" v-model="trabajador.estado" disabled/>
