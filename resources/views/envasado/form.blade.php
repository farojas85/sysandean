<div class="modal fade" id="modal-envasado">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="modal-envasado-title">Nuevo Envasado</h4>
            ...
            <div class="modal-body" id="modal-envasado-body">
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <div class="input-group input-group-sm">
                            ...
                            v-model="envasado.lote_nombre" @change="buscarLotes" />
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control form-control-sm" placeholder="Ingrese Kilogramos Envasados"
                            v-model="envasado.kilogramo_envasado" :class="{ 'is-invalid' : errores.kilogramo_envasado }" />
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8 ">
                        <select v-model="envasado.trabajador_id" class="form-control form-control-sm" >
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8 ">
                        <textarea rows="2" class="form-control form-control-sm" placeholder="Ingrese Obseración"
                            v-model="envasado.observacion" ></textarea>
                ...
                <div class="modal-footer form-group text-center">
                    ...
                    &nbsp;
                    <button type="submit" class="btn btn-success btn-guardar-materia" :value='envasado.estadoCrud'
                            name="btn-guardar-materia" @click.prevent="guardar">
                            <i :class="(envasado.estadoCrud == 'nuevo') ? 'fa fa-save' : 'fa fa-refresh'"></i>  
                        @{{ ( envasado.estadoCrud == 'nuevo' ? 'Guardar' : 'Actualizar')}}
                    </button> 
                </div>
            </div>
        </div>
